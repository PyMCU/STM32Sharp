...
namespace STM32.Peripherals.Ppb;

/// <summary>
/// Private Peripheral Bus (PPB) — NVIC, SysTick, and System Control Block (SCB).
/// Register at base 0xE000E000 (Size = 0x1000) via Bus.RegisterPeripheral.
/// The PeripheralBus hands this device an offset relative to that base, so the
/// register offset is simply <c>address &amp; 0xFFF</c>.
/// </summary>
