    ...
    string Notes)
{
    ...
    public static Stm32ChipPreset Custom(uint flashSize, uint sramSize, uint clockHz = 16_000_000) =>
        new("STM32 (custom)", CortexCore.CortexM0Plus, flashSize, sramSize, clockHz,
    ...
    public static readonly Stm32ChipPreset G071 = new(
        "STM32G071", CortexCore.CortexM0Plus, 128 * 1024, 36 * 1024, 16_000_000,
    ...
    public static readonly Stm32ChipPreset G031 = new(
        "STM32G031", CortexCore.CortexM0Plus, 64 * 1024, 8 * 1024, 16_000_000,
        HasDmamux: true, FullFidelity: true,
    ...
    public static readonly Stm32ChipPreset C031 = new(
        "STM32C031", CortexCore.CortexM0Plus, 32 * 1024, 12 * 1024, 12_000_000,
        HasDmamux: true, FullFidelity: true,
    ...
    // ── STM32L0 (Wokwi; partial fidelity) ────────────────────────────────

    /// <summary>
    /// STM32L031 — Wokwi's Nucleo-L031K6. 32 KB Flash / 8 KB SRAM, Cortex-M0+.
    /// Partial fidelity: APB peripheral base addresses match the G0 map (GPIO/USART/TIM/SPI/I2C run),
    /// but the L0's RCC and Flash controllers and its MSI clock tree differ, and it has no DMAMUX.
    /// HAL clock setup and Flash programming written for the L0 are not modeled.
    /// </summary>
    public static readonly Stm32ChipPreset L031 = new(
        "STM32L031", CortexCore.CortexM0Plus, 32 * 1024, 8 * 1024, 2_097_000,
        HasDmamux: false, FullFidelity: false,
        Notes: "Partial: GPIO/USART/TIM/SPI/I2C share the G0 base addresses, but the L0 RCC/Flash/MSI " +
               "clock tree differs and there is no DMAMUX. Bare-metal I/O works; L0-specific clock/Flash does not.");
    ...
    public static readonly Stm32ChipPreset F103C8 = new(
        "STM32F103C8", CortexCore.CortexM3, 64 * 1024, 20 * 1024, 8_000_000,
        HasDmamux: false, FullFidelity: false,
