...
using STM32.Core.Cpu.Instructions;
using STM32.Core.Helpers;
using unsafe InstructionHandler = delegate* managed<ushort, STM32.Core.Cpu.CortexM0Plus, void>;

namespace STM32.tests.Cpu;
